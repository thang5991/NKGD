...
function useTradesStore() {
  ...
  const saveTradeWithImages = async (
    ...
    const tradeToSave: Trade = {
      ...
      complianceReviewed: tradeData.complianceReviewed || false,
      complianceScore: tradeData.complianceReviewed ? tradeData.complianceScore : undefined,
      violatedRules: tradeData.complianceReviewed ? (tradeData.violatedRules || []) : [],
